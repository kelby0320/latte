 ...
 *
 * @param vm_area       Pointer to vm area
 * @param base_vaddr    Base virtual address to search for a free virtual
 * address
 ...
 *
 * @param vm_area       Pointer to vm area
 * @param base_vaddr    Base virtual address to search for free virtual
 * addresses
...
vm_area_map_page_range(
    struct vm_area *vm_area, void *virt, void *phys, size_t count,
    uint8_t flags);
